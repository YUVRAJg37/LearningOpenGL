...
int main()
{
    ...
    // ------------------------------------
    Shader objectShader("Shader/Shaders/Object/shader.vert", "Shader/Shaders/Object/shader.frag"),
        lightShader("Shader/Shaders/Light/shader.vert", "Shader/Shaders/Light/shader.frag");
    ...
    while (!glfwWindowShouldClose(window))
    {
        ...
        glUniformMatrix4fv(glGetUniformLocation(objectShader.ID, "projection"), 1, GL_FALSE, &projection[0][0]);
        glUniformMatrix4fv(glGetUniformLocation(objectShader.ID, "view"), 1, GL_FALSE, &view[0][0]);
        glm::mat4 model = glm::mat4(1.0f);
        //objectShader.setMat4("model", model);
        glUniformMatrix4fv(glGetUniformLocation(objectShader.ID, "model"), 1, GL_FALSE, &model[0][0]);
